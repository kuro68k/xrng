...
typedef struct USB_MicrosoftExtendedPropertiesDescriptor {
	...
	uint32_t	dwPropertySize2;
	uint32_t	dwPropertyDataType2;
	uint16_t	wPropertyNameLength2;
	wchar_t		PropertyName2[6];
	uint32_t	dwPropertyDataLength2;
	wchar_t		PropertyData2[6];
